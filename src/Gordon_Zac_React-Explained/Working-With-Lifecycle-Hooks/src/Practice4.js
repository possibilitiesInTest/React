...
componentDidUpdate(prevProps, prevState) {
  ...
  prevState.points !== this.state.points ? console.log("State Changed!") : console.log("State not changed!");
}
  addPoint = () => {
...
class BarChart extends React.Component {
  ...
  */
  componentDidUpdate(prevProps, prevState) {
    ...
    prevProps.points !== this.props.points ? console.log("Props Changed!") : console.log("no change to props")
